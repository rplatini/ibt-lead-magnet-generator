...
export default function TemplateCard({ template, onDelete }: Props) {
	...
	return (
		<div
			className="rounded-xl border border-slate-200 bg-white p-5 pb-6 min-h-[160px] shadow-sm hover:shadow-md transition-shadow flex flex-col gap-4 cursor-pointer"
			onClick={() => navigate(`/templates/${template.id}/reports`)}
		>
